...
class Solution
{
    ...
    vector<int> topView(Node *root) {
        ...
        while(!q.empty()) {
            ...
            if(mp.find(line) == mp.end()) {         //ensure that we dont have any of the line that we got, and
               mp[line] = node->data;               //if line is not in mp then only insert in the mp with corres. data of node
            }
